...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <!-- Form Add -->
                <form action="add_pengelola_proses.php" method="POST" enctype='multipart/form-data' id='demo-form2' data-parsley-validate class='form-horizontal form-label-left'>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label class="control-label col-md-3 col-sm-3 col-xs-3">Bank</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
