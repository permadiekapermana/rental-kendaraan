    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <?php
                    $i=0;
                    $sqlsewa = "SELECT booking.*,mobil.*,merek.*,users.* FROM booking,mobil,merek,users WHERE mobil.id_pengelola='$_SESSION[id_pengelola]' AND booking.id_mobil=mobil.id_mobil AND merek.id_merek=mobil.id_merek AND users.email=booking.email  ORDER BY booking.kode_booking DESC";
                ...
                <tr>
                    ...
                    <!-- <a href="sewaeditbayar.php?id=<?php echo $result['kode_booking'];?>"><i class="fa fa-edit"></i></a> -->
                    </td>
                </tr>
                <?php }?>
                </tbody>
