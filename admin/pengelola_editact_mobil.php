...
$sql="UPDATE mobil SET id_kategori='$id_kategori', nama_mobil='$vehicletitle',nopol='$nopol',id_merek='$brand',deskripsi='$vehicleoverview',harga='$priceperday',bb='$fueltype',tahun='$modelyear',
